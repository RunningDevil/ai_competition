...
| 每一类文件后缀数量                      | 不固定                                                                                                                                     |
| doc、docx、ppt、pptx、xls、xlsx文件内容 | 除正文外，还包含批注，批注类型参考[办公文件批注统一规范](#办公文件批注统一规范)                                                            |
| xml、java、py、html、md、js文件内容     | 除正文外，还包含批注，批注类型参考[代码文件批注规范](#代码文件批注规范)                                                                    |
...
| 问题格式   | 除正文外，还包含批注，批注类型参考[代码文件批注规范](#代码文件批注规范)                                                          |
...
格式固定，内容不固定，参考[Permission](./Permission.json)
...
题目统一使用 JSON 数组格式存储在 `question/group-X.md` 文件中，每组 20 道题，参考：[题目样例](./question/group-1.md)。
...
答案统一使用 JSON 数组格式存储在 `llm-wiki/output/group-x-answer.md` 文件中，每组 20 道题的答案，参考[答案输出格式](./output/group-1-answer.md)。

answer完全按照[题目格式](#题目格式)中的answer_format要求给出
